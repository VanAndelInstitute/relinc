...
**Finally**, the worked examples below assume that the `relinc` github 
repository is available in your current working directory so that it can 
access data files provided in that repository. This is simply achieved from 
